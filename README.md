...
### Projeto desenvolvido no curso da Trybe, turma 9. Requisitos desenvolvidos pela Trybe

Na raiz do diretório do projeto, execute o seguinte comando que fará a restauração da base de dados `dataFlights`:
    ```sh
